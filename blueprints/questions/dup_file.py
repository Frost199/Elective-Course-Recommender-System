...
def time_up_from_client():
    ...
    #     print(val)
    #     session["finished"] = "yes"
    #     return jsonify({"url_action": 'redirect'})
...
def past_record():
    ...
    sye_pie_chart = "Students Performance in Artificial Intelligence for COS819 and COS808"
    for i in splited_course:
        if i == "Artificial Intelligence":
            ...
            # cluster_1 = Clustering('models/aos_questions_and_answer/dataset/clustering/system_eng_cluster.csv')
            first_cluster_1, second_cluster_1, third_cluster_1, fourth_cluster_1, fifth_cluster_1, sixth_cluster_1, \
            _, first_cluster_2, second_cluster_2, third_cluster_2, fourth_cluster_2, fifth_cluster_2, sixth_cluster_2, \
            _ = cluster_function('models/aos_questions_and_answer/dataset/clustering/ai_cluster.csv')

            ai_cos843.add("Region 1", first_cluster_1)
            ai_cos843.add("Region 2", second_cluster_1)
            ai_cos843.add("Region 3", third_cluster_1)
            ai_cos843.add("Region 4", fourth_cluster_1)
            ai_cos843.add("Region 5", fifth_cluster_1)
            ai_cos843.add("Region 6", sixth_cluster_1)
            ai_cos843_data = ai_cos843.render_data_uri()

            ai_cos828.add("Region 1", first_cluster_2)
            ai_cos828.add("Region 2", second_cluster_2)
            ai_cos828.add("Region 3", third_cluster_2)
            ai_cos828.add("Region 4", fourth_cluster_2)
            ai_cos828.add("Region 5", fifth_cluster_2)
            ai_cos828.add("Region 6", sixth_cluster_2)
        ...
        if i == "Computer Networks":
            ...
            first_cluster_1, second_cluster_1, third_cluster_1, fourth_cluster_1, fifth_cluster_1, sixth_cluster_1, \
            _, first_cluster_2, second_cluster_2, third_cluster_2, fourth_cluster_2, fifth_cluster_2, sixth_cluster_2, \
            _ = cluster_function('models/aos_questions_and_answer/dataset/clustering/computer_networks.csv')

            cn_cos847.add("Region 1", first_cluster_1)
            cn_cos847.add("Region 2", second_cluster_1)
            cn_cos847.add("Region 3", third_cluster_1)
            cn_cos847.add("Region 4", fourth_cluster_1)
            cn_cos847.add("Region 5", fifth_cluster_1)
            cn_cos847.add("Region 6", sixth_cluster_1)
            cn_cos847_data = cn_cos847.render_data_uri()

            cn_cos842.add("Region 1", first_cluster_2)
            cn_cos842.add("Region 2", second_cluster_2)
            cn_cos842.add("Region 3", third_cluster_2)
            cn_cos842.add("Region 4", fourth_cluster_2)
            cn_cos842.add("Region 5", fifth_cluster_2)
            cn_cos842.add("Region 6", sixth_cluster_2)
        ...
        if i == "Software Engineering":
            ...
            first_cluster_1, second_cluster_1, third_cluster_1, fourth_cluster_1, fifth_cluster_1, sixth_cluster_1, \
            _, first_cluster_2, second_cluster_2, third_cluster_2, fourth_cluster_2, fifth_cluster_2, sixth_cluster_2, \
            _ = cluster_function('models/aos_questions_and_answer/dataset/clustering/software_eng_cluster.csv')

            se_cos829.add("Region 1", first_cluster_1)
            se_cos829.add("Region 2", second_cluster_1)
            se_cos829.add("Region 3", third_cluster_1)
            se_cos829.add("Region 4", fourth_cluster_1)
            se_cos829.add("Region 5", fifth_cluster_1)
            se_cos829.add("Region 6", sixth_cluster_1)
            se_cos829_data = se_cos829.render_data_uri()

            se_cos826.add("Region 1", first_cluster_2)
            se_cos826.add("Region 2", second_cluster_2)
            se_cos826.add("Region 3", third_cluster_2)
            se_cos826.add("Region 4", fourth_cluster_2)
            se_cos826.add("Region 5", fifth_cluster_2)
            se_cos826.add("Region 6", sixth_cluster_2)
            se_cos826_data = se_cos826.render_data_uri()

        if i == "Systems Engineering":
            sye_cos819 = pygal.Pie()
            sye_cos819.title = "Performance for COS819"

            sye_cos808 = pygal.Pie()
            sye_cos808.title = "Performance for COS808"
            first_cluster_1, second_cluster_1, third_cluster_1, fourth_cluster_1, fifth_cluster_1, sixth_cluster_1, \
            _, first_cluster_2, second_cluster_2, third_cluster_2, fourth_cluster_2, fifth_cluster_2, sixth_cluster_2, \
            _ = cluster_function('models/aos_questions_and_answer/dataset/clustering/system_eng_cluster.csv')

            sye_cos819.add("Region 1", first_cluster_1)
            sye_cos819.add("Region 2", second_cluster_1)
            sye_cos819.add("Region 3", third_cluster_1)
            sye_cos819.add("Region 4", fourth_cluster_1)
            sye_cos819.add("Region 5", fifth_cluster_1)
            sye_cos819.add("Region 6", sixth_cluster_1)
            sye_cos819_data = sye_cos819.render_data_uri()

            sye_cos808.add("Region 1", first_cluster_2)
            sye_cos808.add("Region 2", second_cluster_2)
            sye_cos808.add("Region 3", third_cluster_2)
            sye_cos808.add("Region 4", fourth_cluster_2)
            sye_cos808.add("Region 5", fifth_cluster_2)
            sye_cos808.add("Region 6", sixth_cluster_2)
...
def cluster_function(csv_to_load):
    ...
    return first_cluster_pie_chart_1, second_cluster_pie_chart_1, third_cluster_pie_chart_1, \
           ...
           total_number_of_students_in_second_course
